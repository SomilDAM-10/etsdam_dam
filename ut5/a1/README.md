...
|:------------------------------:|:---------------------------------------------------------------------------------------:|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|
| Ciudadano / Usuario Registrado | Persona que utiliza la plataforma para gestionar sus actividades deportivas personales. | - Registrarse       - Iniciar sesión (Requerido para gestionar perfil y reservas)       -  Modificar perfil               - Consultar disponibilidad         - Realizar reserva (include Enviar confirmación email)     -Cancelar reserva (Condición: >24h de antelación) |
|         Administrador          | Personal encargado de la gestión técnica y operativa de las instalaciones y usuarios. |                                                                 - Gestionar instalaciones (Añadir, modificar o desactivar)    -  Consultar listado de usuarios    - Bloquear usuario   -  Gestionar horarios                                                                 |
|    Usuario / Administrador     |             Sistema automatizado que interactúa para notificar al usuario.             |                                                                                                                        Enviar correo de confirmación                                                                                                                         |
|                                |                                                                                         |                                                                                                                                                                            
